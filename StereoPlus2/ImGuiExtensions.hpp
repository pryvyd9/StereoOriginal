...
namespace ImGui::Extensions {
  ...
  //  }
    ...
    static void StyleColorsStereo(ImGuiStyle* dst = nullptr)
    {
        ...
        colors[ImGuiCol_Border] = ImVec4(0.43f, 0.43f, 0.50f, 1);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_FrameBg] = ImVec4(0.16f, 0.29f, 0.48f, 1);
        colors[ImGuiCol_FrameBgHovered] = ImVec4(0.26f, 0.59f, 0.98f, 1);
        colors[ImGuiCol_FrameBgActive] = ImVec4(0.26f, 0.59f, 0.98f, 1);
        ...
        colors[ImGuiCol_Button] = ImVec4(0.26f, 0.59f, 0.98f, 1);

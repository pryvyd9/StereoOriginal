...
int main(int, char**)
{
	...
	GLuint texture = createTextureAttachment(width, height);
	GLuint depthBuffer = createDepthBufferAttachment(width, height);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 4 custom rendering
		{
			...
			//glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, renderedTexture,  0);
			//
